A simple web-based application to track your job applications by status, bookmark important ones, and manage your progress — all based on user login with email.
